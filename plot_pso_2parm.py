...
def plot1(path,N):
    ...
    popsize = [ 100,200,500,1000,1500]
    maxgen = [40,400,1000,2000,4000]
    d ={}
    for i in popsize:
        d[i]={}
        for j in maxgen:
    ...
    ax2b.set_xlabel('number of particles')
    ax2b.set_ylabel('max iter')
...
def plot2(path,N):
    ...
    list_rates,minlist,maxlist=[],[],[]
    popsize = [ 100,200,500,1000,1500]
    maxgen = [40,400,1000,1500,2000,4000]
    d ={}
    for i in popsize:
        d[i]={}
        for j in maxgen:
    ...
    ax2.set_ylabel('max iter')
    
    plt.show()


plot1("PSO_doublepram1.log",30)
plot2("PSO_doublepram1.log",30)
